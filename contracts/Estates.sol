...
import "./ERC721/ERC721HolderUpgradeable.sol";
...
contract Estates is 
   ...
   ReentrancyGuardUpgradeable 
 {
    ...
    */
   function __Estates_init(address estateManager, address estateOwner) public initializer nonReentrant {
      __Management_init();
   ...
   function changeMetadata(uint256 tokenId, string memory name, string memory symbol) public virtual override onlyEstateManager {
   ...
   function modifyTokenURI(uint256 tokenId, string memory uri) public virtual override onlyEstateManager {
  ...
  function supportsInterface(bytes4 interfaceId) public view virtual override(ERC165Upgradeable, IERC165Upgradeable) returns (bool) {
   ...
   function burn(uint256 tokenId) public virtual override onlyEstateManager {
